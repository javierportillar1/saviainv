...
exports.COLORS = exports.MENU_ITEMS = void 0;
var LEFT_SECTIONS = [
    {
        id: "sanduches",
        titulo: "Sandwiches",
        ...
        items: [
            {
                nombre: "Bowl Salado",
                precio: 15000,
                descripcion: "Personaliza tu bowl: 2 bases (arroz, pasta, quinua), 4 toppings (maíz tierno, champiñones, pico de gallo, guacamole, tocineta, chips de arracacha, queso feta, zanahoria, pepino) y 1 proteína (pechuga de pollo, jamón de cerdo, carne desmechada). Incluye bebida.",
            },
        ],
        side: "left",
    },
        ...
        items: [
            {
                nombre: "Açaí supremo",
                precio: 14500,
                descripcion: "Base: Açaí, fresa, banano, yogurt natural, leche o bebida vegetal. Toppings: Kiwi, fresa, banano, coco, arándanos, semillas, crema de maní.",
            ...
            },
            {
                nombre: "Vital",
                precio: 12000,
                descripcion: "Base: Mango, banano, piña, espinaca, yogurt natural, leche o bebida vegetal. Toppings: Kiwi, arándano, granola, chía latte, coco.",
...
exports.MENU_ITEMS = __spreadArray(__spreadArray([], LEFT_SECTIONS, true), RIGHT_SECTIONS, true).flatMap(function (section) {
    return section.items.map(function (item, index) { return (__assign(__assign({ id: "".concat(section.id, "-").concat(index) }, item), { categoria: section.titulo, stock: Math.floor(Math.random() * 50) + 10, inventarioCategoria: 'No inventariables' })); });
}).concat([
    {
        id: 'inv-mango',
        nombre: 'Mango',
